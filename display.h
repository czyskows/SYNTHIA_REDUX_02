...
int buttonState, prevButtonState, func;
...
void waveformScreen(){
  ...
  tft.setCursor(5, 20);
  tft.setTextColor(SYTNHIA_LIGHTBLUE);
  tft.print("OSC1");
...
void octaveScreen(){
  ...
  tft.drawFastHLine(0, 34, 155, SYTNHIA_LIGHTBLUE);
  tft.drawFastVLine(54, 20, 180, SYTNHIA_LIGHTBLUE);
  tft.drawFastVLine(108, 20, 180, SYTNHIA_LIGHTBLUE);
  tft.setFont(LiberationMono_12);
  tft.setCursor(5, 17);
